import { Yuppi, Patterns, type Schema, type AnyObject, type ValidationError } from "../../src/main";
...
const correct_properties: AnyObject[] = [
  {
    field: "fir4tozden@gmail.com"
  }
];

const faulty_properties: AnyObject[] = [
  {
    field: "fir4tozden@!gmail.com"
  }
];
